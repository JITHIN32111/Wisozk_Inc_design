...
function Section1() {
  return (
    ...
    />
    <div className="absolute inset-14 flex flex-wrap text-center text-white " data-aos='fade-up' data-aos-delay='200'>
      <div className="flex flex-col gap-y-3 sm:gap-y-4 md:gap-y-5 ">
     <h1 className='text-3xl sm:text-5xl font-semibold '>Vision</h1>
